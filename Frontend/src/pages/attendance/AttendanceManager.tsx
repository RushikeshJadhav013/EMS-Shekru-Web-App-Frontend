...
const AttendanceManager: React.FC = () => {
  ...
  const loadOfficeTimings = async () => {
    ...
    try {
      const res = await fetch('testing.staffly.space/attendance/office-hours', {
        headers: {
  ...
  const handleDepartmentTimingDelete = async (timing: OfficeTiming) => {
    ...
    try {
      setOfficeFormLoading(true);
      const res = await fetch(`testing.staffly.space/attendance/office-hours/${timing.id}`, {
        method: 'DELETE',
        headers: {
          ...getAuthHeaders(),
        },
  ...
  const fetchSummary = async () => {
    try {
      const res = await fetch('testing.staffly.space/attendance/summary');
    ...
    (async () => {
      try {
        ...
        const [attendanceRes, employeesRes] = await Promise.all([
          fetch(`testing.staffly.space/attendance/all${query}`, { headers }),
