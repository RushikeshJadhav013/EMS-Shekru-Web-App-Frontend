...
const mapEmployeeData = (emp: any): EmployeeRecord => {
  ...
  const baseUrl = import.meta.env.VITE_API_BASE_URL || 'https://testing.testing.staffly.space    ';
  ...
  const openEditDialog = async (employee: EmployeeRecord) => {
    ...
    const populateForm = (emp: any) => {
      ...
      if (photoUrl && !photoUrl.startsWith('http')) {
        photoUrl = `${import.meta.env.VITE_API_BASE_URL || 'https://testing.testing.staffly.space    '}/${photoUrl}`;
      }
