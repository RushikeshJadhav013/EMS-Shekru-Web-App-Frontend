...
const TaskManagement: React.FC = () => {
  ...
  const taskCountsByStatus = useMemo(() => {
    ...
    return {
      ...
      inProgress: searchFiltered.filter((t) => t.status === "in-progress")
        .length,
                            ...
                            <TableCell>
                              {(task.status as string) === "completed" ||
                                ...
                                >
                                  ...
                                  {(task.status as string) === "completed" && (
                                    <CheckCircle2 className="h-3.5 w-3.5 text-green-600 flex-shrink-0 ml-auto" />
                                  )}
                                  {(task.status as string) === "cancelled" && (
                                    <XCircle className="h-3.5 w-3.5 text-red-600 flex-shrink-0 ml-auto" />
                                  )}
                                  {(task.status as string) === "overdue" && (
                                    <AlertCircle className="h-3.5 w-3.5 text-orange-600 flex-shrink-0 ml-auto" />
                                  )}
                                </div>
                              ) : (
                                <Select
                                  ...
                                  onValueChange={(
                                    ...
                                    if (
                                      ...
                                      toast({
                                        ...
                                        description:
                                          "Cannot move back to this status once the task has progressed further.",
                                        variant: "destructive",
                                      });
                                    }
                                  }}
