...
const AddChatModal: React.FC<AddChatModalProps> = ({ isOpen, onClose, permissions }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-2xl w-full max-w-lg mx-auto shadow-2xl border border-gray-700 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-700 bg-gradient-to-r from-gray-800 to-gray-900">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Connect with your colleagues</p>
            </div>
          </div>
          <Button 
            variant="ghost" 
            size="sm" 
            onClick={onClose}
            className="h-10 w-10 rounded-full hover:bg-gray-700 transition-colors"
          >
          ...
          <div className="px-6 pt-4">
            <TabsList className="grid w-full grid-cols-2 bg-gray-100 p-1 rounded-xl">
              ...
              <TabsTrigger 
                ...
                className="flex items-center space-x-2 rounded-lg data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="px-6 py-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-3 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                <div>
                  ...
                  <Input
                    ...
                    className="border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                <div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedUsers.slice(0, 5).map(userId => {
                      ...
                      return selectedUser ? (
                        <div key={userId} className="flex items-center bg-white rounded-full px-3 py-1 text-sm">
                    ...
                    {selectedUsers.length > 5 && (
                      <div className="flex items-center bg-white rounded-full px-3 py-1 text-sm text-gray-500">
                    ...
                    {filteredUsers.map((user, index) => (
                      ...
                      >
                        <Checkbox
                          ...
                          className="mr-4 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600"
                        />
